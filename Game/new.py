#FUCKING EXpLANATION STARTS WITH '#"
...
# making class jo main badi mushkil se samjha
        ...
        if self.left and self.move:
            ...
            self.walk +=1
             ...
             if self.right_stop:
                ...
                self.left=False # SOME FUNCTIONS
                self.right = False
...
# EK AUR CLASS JARURAT nahi tha lekin mai tympas k  liye bna diya
...
Num_bullets = 0
#Looks complicated lekin easy hai dhyan se dekhega toh    
while run:
    text = font.render("idk what the fk is this", 1, (0,0,0))
    win.blit(text, (0, 10))
    clock.tick(27)
